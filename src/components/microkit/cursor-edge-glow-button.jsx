...
export function CursorEdgeGlowButton() {
  ...
  return (
    <div ref={containerRef} className="relative z-10 inline-flex items-center">
      ...
      <button ref={buttonRef} type="button" className="relative z-10 flex h-10 cursor-pointer items-center justify-center gap-1 overflow-hidden rounded-full border border-[var(--linha-forte)] bg-[var(--areia)] px-[3.25rem] text-xs font-bold uppercase leading-none tracking-[-.015em] text-[var(--terra-escura)] transition-colors duration-200 ease-[cubic-bezier(.4,0,.2,1)] [font-family:Inter,-apple-system,'Segoe_UI',sans-serif] focus-visible:outline-2 focus-visible:outline-offset-8 focus-visible:outline-[var(--terra-clara)]">
        ...
        <svg className="h-[9px] w-[17px] flex-none text-[var(--terra-escura)]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 17 9" aria-hidden="true">
